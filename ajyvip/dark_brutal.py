...
def vak(s):
    for c in s + '\n':
        ...
        sys.stdout.flush()
        time.sleep(1./1000)
kata("ANAK AJG CONTOH CONTOH ANAK AJG:V")
def jenius():
    ua={
    "accept": "*/*",
...
if __name__=="__main__":
     try:
          ...
          clear()
          vak('''
\033[92;1m\033[91m______________________________________________________________________________
|                                                                              |
...
|______________________________________________________________________________|''')
          ...
          jenius()
          time.sleep(5)
          kata("\033[1;91mCOVID BERHASIL DIKIRIM :V")
          oyo()
          time.sleep(5)
          kata("\033[1;91mCOVID BERHASIL DIKIRIM :V")
          mapclub()
